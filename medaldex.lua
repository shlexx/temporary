...
decompile = function(Script)
	...
	if ms then return mr end
	local ms2,mr2 = pcall(function()
...
return DecompileScript
	...
	if ms2 then return mr2 end
	local ms3,mr3 = pcall(function()
