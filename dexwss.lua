...
function ssdecomp(obj)
local source
if obj:IsA("Script") then
if obj.Name == "AutomaticUpdating" then
...
elseif obj.Name == "DescendantCounter" then
...
elseif obj.Name == "ServerEndpoint" then
...
elseif obj.Name == "PluginInitializer" then
...
local function main()
	...
	ScriptViewer.ViewScript = function(scr)
		local success, source = pcall(ssdecomp or env.decompile or function() end, scr)
